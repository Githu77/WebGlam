        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
          ...
          <div className="space-y-6 lg:col-span-2">
            <Link href="/" className="flex items-center space-x-3 mb-4 group">
              <img src="https://res.cloudinary.com/dhiouuz96/image/upload/v1750248220/TheGlam_6_iynz5m.png" alt="WebGlam Logo" className="w-12 h-12 group-hover:scale-110 transition-transform duration-300" />
              ...
              {[
                ...
                <li key={item.name}>
                  ...
                  >
                    ...
                    {item.badge && (
                      <Badge variant="secondary" className="ml-2 text-xs bg-indigo-700 text-indigo-100">
                        {item.badge}
                      </Badge>
                    )}
                  </Link>
